Public Class clsDraftDocument
    ...
    Private Sub LoadForm()
        Try
            ...
            oForm.Freeze(True)
            oForm.PaneLevel = 1
            strQuery = "SELECT U_UdfName FROM ""@Z_DRFT"""
...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("SELECT * FROM ""@Z_DRFT""   where U_DocType='S' order by U_Order")
            ...
            dtTemp1.ExecuteQuery("SELECT * FROM ""@Z_DRFT""  where U_DocType='P' order by U_Order")
...
#Region "AddtoUDT"
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        oGrid = aform.Items.Item("8").Specific
        oUserTable = oApplication.Company.UserTables.Item("Z_DRFT")
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            ElseIf strCode = "" Then
                ...
                'For Each element As DictionaryEntry In getHashtable()
                '    oUserTable.Code = element.Key
                '    oUserTable.Name = element.Value
                '    oUserTable.UserFields.Fields.Item("U_DocType").Value = "S"
                '    oUserTable.UserFields.Fields.Item("U_Table").Value = "ODRF"
                '    oUserTable.UserFields.Fields.Item("U_Order").Value = intOrder
                '    intOrder = intOrder + 1
                ...
                oUserTable.UserFields.Fields.Item("U_DocType").Value = "S"
                oUserTable.UserFields.Fields.Item("U_Table").Value = "ODRF"
                oUserTable.UserFields.Fields.Item("U_Order").Value = 0
                intOrder = intOrder + 1
                If oUserTable.Add <> 0 Then
                    oApplication.Utilities.Message(oApplication.Company.GetLastErrorDescription, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Return False
        ...
        oGrid = aform.Items.Item("9").Specific
        oUserTable1 = oApplication.Company.UserTables.Item("Z_DRFT")
        strType = oApplication.Utilities.getEdittextvalue(aform, "7")
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            strCode = oGrid.DataTable.GetValue("Code", intRow)
            Try
