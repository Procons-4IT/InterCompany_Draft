...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "OITT" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_DRFT", "Draft Document Setup", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_DRFT", "Table", "Table Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_DRFT", "UdfName", "UDF Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            addField("@Z_DRFT", "Active", "Active", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("@Z_DRFT", "DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "S,P", "Sales,Purchase", "S")
            AddFields("Z_DRFT", "Order", "Order", SAPbobsCOM.BoFieldTypes.db_Numeric)
